    ...
    return (
        <div className='servicos'>
            ...
            <ul className='listaServicos'>
                ...
                <li className='itemServicos'>&#129520; Instalação de ar-condicionado</li>
                <li className='itemServicos'>&#129520; Manutenção e higienização de ar-condicionado</li>
                <li className='itemServicos'>&#129520; Vendas de ar-condicionado e materiais elétricos</li>
            </ul>
        </div>
    )
}
